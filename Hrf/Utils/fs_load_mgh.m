function [vol, M, mr_parms, volsz] = fs_load_mgh(fname,slices,frames,headeronly)
% [vol, M, mr_parms, Mdc, volsz] = fs_load_mgh(fname,<slices>,<frames>,<headeronly>)
%
% fname - path of the mgh file (including extension)
% 
...
%
%
% 25/3/2017 - MODIFIED BY SAM SCHWARZKOPF FOR USE WITH SAMSRF!
%
